...
int main() {
    // Datos medidos manualmente: número de hilos y tiempo en segundos
    int p[] = {1, 2, 4, 8, 12};
    double time_s[] = {0.009780, 0.004915, 0.002446, 0.002161, 0.001420};
    int n = sizeof(p) / sizeof(p[0]);

    double T1 = time_s[0]; // tiempo con 1 hilo
    ...
    for (int i = 0; i < n; i++) {
        double S = T1 / time_s[i];   // speedup
        double E = S / p[i];         // eficiencia
